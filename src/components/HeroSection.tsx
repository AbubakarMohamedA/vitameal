        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 text-white">
            ...
            <p className="text-l md:text-xl text-white/90 leading-relaxed max-w-2xl">
              Transforming nutrition across Africa through innovative food fortification solutions 
              and comprehensive commodity trading services.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link
                href="#about"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 text-lg font-medium bg-[#789FB3] text-primary rounded-md shadow-md transition-all group"
              >
                Get Started
              ...
              <Link
                href="#services"
                className="inline-flex items-center justify-center px-6 py-3 text-lg font-medium border-2 border-[#789FB3] text-white rounded-md hover:bg-[#789FB3] hover:text-primary transition-all"
              >
                Our Solutions
              </Link>
            </div>
